...
export default function Scene({ frameIndex, objects, showPointsFor, showBoxes, compact, plain }) {
  ...
  return (
    <svg viewBox="0 0 320 190" preserveAspectRatio="xMidYMid slice">
      ...
      {!plain && <rect x={12} y={12} width={296} height={166} rx={16} fill="var(--surface)" stroke="var(--border)" strokeWidth={1.2} />}
